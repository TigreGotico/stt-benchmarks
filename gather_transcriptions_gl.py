...
from ovos_stt_plugin_nos import NosSTT
...
STTS = [
    ...
    ("ovos-stt-plugin-nos", "proxectonos/Nos_ASR-wav2vec2-large-xlsr-53-gl-with-lm", NosSTT({"lang": LANG})),
    ...
    #("ovos-stt-plugin-fasterwhisper-zuazo", "whisper-small-gl", FasterWhisperSTT({"model": "Jarbas/faster-whisper-small-gl-cv13",
    #                   "beam_size": 5,
    #                   "cpu_threads": 4
    #                   }))
]
...
DATASETS = [(ds[0],
            ...
            for ds in [
                ("openslr/openslr", "SLR77", "train", True),
                ("google/fleurs", "gl_es", "test", True),
                ("mozilla-foundation/common_voice_17_0", "gl", "test", True),
            ]]
